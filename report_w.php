...
$monthly_expense[0]["label"] = "rent";
$monthly_expense[1]["label"] = "insurance";
$monthly_expense[2]["label"] = "loan";
$monthly_expense[3]["label"] = "transportation";
$monthly_expense[4]["label"] = "dine";
$monthly_expense[5]["label"] = "utilities";
...
for ($count = 0; $count < 10; $count++) {
    ...
    $query = "SELECT `$label` FROM working WHERE username='$uname'";
...
$budget[0]["label"] = "rent";
$budget[1]["label"] = "insurance";
$budget[2]["label"] = "loan";
$budget[3]["label"] = "transportation";
$budget[4]["label"] = "dine";
$budget[5]["label"] = "utilities";
...
$expense[0]["label"] = "rent";
$expense[1]["label"] = "insurance";
$expense[2]["label"] = "loan";
$expense[3]["label"] = "transport";
$expense[4]["label"] = "dine";
$expense[5]["label"] = "utilities";
...
for ($count = 0; $count < 10; $count++) {
    ...
    $query = "SELECT `$label` FROM working_expense WHERE userid='$uname'";
    $result = $con->query($query);
    if ($result) {
        $row = $result->fetch_assoc();
...
<nav>
        <div class="topnav">
            ...
            <a href="w_dashboard.php">Dashboard</a>
