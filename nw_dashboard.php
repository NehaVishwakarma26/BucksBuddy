...
<body>
    ...
    <div class="container">
        ...
        <ul class="field-list">
            <li class="fields">
                <a href="nonworkingbudget.php"><img src="budgeting.png" alt="Budgeting"></a>
                <h2>Budgeting</h2>
                <p>Track your expenses and create budgets to manage your finances effectively.</p>
            </li>
            <li class="fields">
                <a href="expensetracker_nw.php"><img src="expensetracking.png" alt="Expense Tracking"></a>
            ...
            <li class="fields">
                <a href="report_nw.php"><img src="report.jpg" alt="Financial Reports"></a>
