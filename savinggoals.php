...
{
    echo "<script>alert('Target date has already passed! Please set a future target date.');
...
<body>
    ...
    <div class="nav">
        <div class="topnav">
            ...
            <a href="checksaving.php">Check Goals</a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="right">
            ...
            <div class="enter_savinggoals">
                ...
                <div class="addsgoal flex fl-col">
                    ...
                    <div class="sgoals-title">Saving Goal</div>

                    <form action="savinggoals.php" method="post" id="myForm" class="flex fl-col">
            ...
            <input type="text" class="input-feild" id="category" name="category" placeholder="Category.." autofocus> -->
                        ...
                        <h class="sub-title">Additional note </h>
                        <input type="text" class="input-feild" id="goalnote" name="note" placeholder="note.." autofocus>

                        <h class="sub-title">Target Date </h>
                        <input type="date" class="input-feild" id="Targetdate" name="targetdate" autofocus>

                        <div class="primary-btn flex" id="addgoal" value>Add Goal <ion-icon name="arrow-forward-outline"></ion-icon>
